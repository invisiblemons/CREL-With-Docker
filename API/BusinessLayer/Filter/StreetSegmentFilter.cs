...
public class StreetSegmentFilter : PaginationParams
{
    public IQueryable<StreetSegment> ApplyFilter(IQueryable<StreetSegment> query)
    {
	...
	public const int DistrictIdAscending = 7;
	public const int DistrictIdDescending = 7 + 1;
