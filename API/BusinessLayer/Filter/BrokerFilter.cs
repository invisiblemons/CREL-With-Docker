...
public class BrokerFilter : PaginationParams
{
    public IQueryable<Broker> ApplyFilter(IQueryable<Broker> query)
    {
	...
	public const int EmailAscending = 15;
	public const int EmailDescending = 15 + 1;

	public const int PhoneNumberAscending = 17;
	public const int PhoneNumberDescending = 17 + 1;

	public const int StatusAscending = 19;
	public const int StatusDescending = 19 + 1;

	public const int TeamIdAscending = 21;
	public const int TeamIdDescending = 21 + 1;
