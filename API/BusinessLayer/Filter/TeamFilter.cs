...
public class TeamFilter : PaginationParams
{
    public IQueryable<Team> ApplyFilter(IQueryable<Team> query)
    {
	...
	public const int DescriptionAscending = 3;
	public const int DescriptionDescending = 3 + 1;
