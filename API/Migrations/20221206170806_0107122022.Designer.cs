...
namespace CREL_BE.Migrations
{
    ...
    [Migration("20221206170806_0107122022")]
    partial class _0107122022
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BrandRequestProperty", b =>
                {
                    b.Property<decimal>("BrandRequestsId")
                        .HasColumnType("decimal(18,0)");

                    b.Property<decimal>("PropertiesId")
                        .HasColumnType("decimal(18,0)");

                    b.HasKey("BrandRequestsId", "PropertiesId");

                    b.HasIndex("PropertiesId");

                    b.ToTable("BrandRequestProperty");
                });
            ...
            modelBuilder.Entity("CREL_BE.Entities.Contract", b =>
                {
                    ...
                    b.Property<string>("BrandRepresentativeAddress")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("BrandRepresentativeBirthday")
                        .HasColumnType("datetime2");

                    b.Property<string>("BrandRepresentativeCccd")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BrandRepresentativeCccdGrantAddress")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("BrandRepresentativeCccdGrantDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("BrandRepresentativeName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BrandRepresentativePhoneNumber")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("LessorBank")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("LessorBankAccountNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("LessorBirthDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("LessorCccd")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("LessorCccdGrantAddress")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("LessorCccdGrantDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("RegistrationNumberGrantAddress")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("RegistrationNumberGrantDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("RenterOfficeAddress")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CREL_BE.Entities.ContractTerm", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,0)")
                    ...
                    b.Property<decimal?>("ContractTermId")
                        .HasColumnType("decimal(18,0)")
                    ...
                    b.HasIndex("ContractTermId", "ContractId");
            ...
            modelBuilder.Entity("CREL_BE.Entities.Property", b =>
                {
                    ...
                    b.Property<int?>("NumberOfFrontage")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BrandRequestProperty", b =>
                {
                    b.HasOne("CREL_BE.Entities.BrandRequest", null)
                        .WithMany()
                        .HasForeignKey("BrandRequestsId")
            ...
            modelBuilder.Entity("CREL_BE.Entities.ContractTerm", b =>
                {
                    ...
                    b.HasOne("CREL_BE.Entities.ContractTerm", null)
                        .WithMany("ContractTerms")
