...
export class ProjectService {
  ...
  getProjects(): Observable<any> {
    return this.httpClient.get<Project[]>(`${this.projectURL}?OrderBy=2&PageSize=100`);
  }
  
  getActiveProjects(): Observable<any> {
    return this.httpClient.get<Project[]>(`${this.projectURL}?OrderBy=2&PageSize=100&MinStatus=1`);
  }
