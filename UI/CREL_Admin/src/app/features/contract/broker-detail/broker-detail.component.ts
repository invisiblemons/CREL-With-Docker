...
export class BrokerDetailComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    // Load Data
    this.brokerServices.getBrokerById(this.contract.broker.id)
      .pipe(
  ...
  openTeamDetail() {
    this.reloadService.routingReload("/nhan-su/nhom/chi-tiet", this.broker.team.id)
  }
}
