...
export class PropertyService {
  ...
  getProperties(): Observable<any> {
    return this.httpClient.get<Property[]>(`${this.propertyURL}?OrderBy=10&PageSize=100`);
  }
  ...
  getActiveProperties(): Observable<any> {
    return this.httpClient.get<Property[]>(`${this.propertyURL}?OrderBy=10&PageSize=100&Status=2`);
  }

  getSpecificProperties(): Observable<any> {
    return this.httpClient.get<Property[]>(`${this.propertyURL}?OrderBy=10&PageSize=100&ListStatus=0&ListStatus=3`);
  }
  ...
  //   return this.httpClient.delete<Property>(`${this.propertyURL}/${property.id}`);
  // }
  ...
  insertMediaForProperty(id, imgArray): Observable<Property>  {
    return this.httpClient.post<Property>(`${this.propertyURL}/${id}/Media`, imgArray);
  }

  insertCertificationForProperty(id, imgArray): Observable<Property>  {
    return this.httpClient.post<Property>(`${this.propertyURL}/${id}/certification`, imgArray);
  }

  insertOwnersForProperty(id,ownerIds): Observable<Property> {
    return this.httpClient.post<Property>(`${this.propertyURL}/${id}/Owners`, ownerIds)
  }
