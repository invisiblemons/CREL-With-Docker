  ...
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  @Input() districtsFromProperty: District[];
  ...
  ngOnChanges(changes: SimpleChanges) {
    if (changes['districtsFromProperty']&&changes['districtsFromProperty'].currentValue) {
      this.districts = changes['districtsFromProperty'].currentValue;
